class Polymomial():
    ...
    def show(self):
        """This will creates the ploynomail in the specific order"""
        ...
        for i in range(self.degree+1):##This will not run in case if list has more elements and degree is less because self.degree becomes zero
            ...
            if self.degree==0:
                ...
                self.degree -= 1
    def __str__(self):
        """This will print the polynomail"""
        return self.polynomial
    def __add__(self,other):
        """This will add the two polynomials when the degree of first polynomial
        is greater than the degree of second polynomial"""
        if self.degree2>other.degree2:
            ...
            return self.new3
        if self.degree2<other.degree2:
            """This will add them when the degrree of second polynomial is greater"""
        ...
        if self.degree1==other.degree1:
            """This will add the two polynomials when both the degrees are same"""
