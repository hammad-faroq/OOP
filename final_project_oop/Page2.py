...
class Second_page:
    ...
    def insert_data(self):
        ...
        try:
            self.cur.execute("CREATE TABLE DATA2 (id SERIAL PRIMARY KEY,BOARD TEXT,DEGREE TEXT,EXAM_TYPE TEXT,PASSING_YEAR TEXT,ROLL_NO TEXT,REGESTRATION_NO TEXT,TOTAL_MARKS TEXT,OBTAINED_MARKS TEXT,GRADE TEXT,DIVISION TEXT)")
        except:
            self.add_data()
        else:
            self.add_data()
