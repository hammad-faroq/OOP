...
bsdsf22a008 Waijid Ali
bsdsf22a007 Abdul Munaf
bsdsf22a026 Hammad Farooq
bsdsf22a037 Muhammad Farhan
"""
class Admission:
    def __init__(self):
        self.con=sqlite3.connect("applicatttion.db")
    ...
    def insert_data(self):
        ...
        try:
            self.cur.execute("CREATE TABLE DATA (id SERIAL PRIMARY KEY,NAME TEXT,CNIC TEXT,FATHER_NAME TEXT,FATHER_CNIC TEXT,FATHER_OCCUPATION TEXT,GENDER TEXT,DATE_OF_BIRTH TEXT,BLOOD_GROUP TEXT,MARIATAL_STATUS TEXT,RELIGION TEXT,HAFIZ TEXT,MOBILE_NO TEXT,GUARDIAN_CONTACT_NO TEXT,EMAIL TEXT,PROVINCE TEXT)")
